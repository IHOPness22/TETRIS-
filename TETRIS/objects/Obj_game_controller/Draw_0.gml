...
//draw the next block 
for (var i = 0; i < array_length(new_cells); i++) {
    var dx = next_block.x + new_cells[i].x;
    var dy = next_block.y + new_cells[i].y;
    draw_sprite(next_block.sprite, 0, dx*cell, 300+dy*cell);
}
